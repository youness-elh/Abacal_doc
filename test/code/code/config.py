import numpy as np
directories = {
				"root":"//isi/w/elh/Gradient_descent_config",
				'odb_folder':'test',
				'code_folder': 'code',
				...
				'Abaqus_inputs':{
						'heat_file':'test/SP013_X6CR.f',
						'input_file':'test/SP013_X6CR.inp',
						'mesh_file':'test/SP013_X6CR.fem',
						'material_file':'test/WSModell_Kinematic_new.ssc',
				}
